...
## Won't pretend chat-with-AI is the end-user product people want
- Chat is sandbox to discover prompt chains; productize templates/workflows/agents. (Napier)

## Won't skip data infrastructure when claiming AI analytics
